...
@section('content')
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">آیکون‌های Awesome Stroke - تعداد: 202</h4>
                                <p class="category">ساخته‌ای از دوستان ما از <a target="_blank" href="http://themes-pixeden.com/font-demos/7-stroke/index.html">Pixeden</a></p>
                            </div>
